...
namespace ProgrammersBlog.Mvc.Areas.Admin.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            var categoriesCountResult = await _categoryService.CountByNoneDeletedAsync();
            var articlesCountResult = await _articleService.CountByNoneDeletedAsync();
            var commentCountResult = await _commentService.CountByNoneDeletedAsync();
            ...
            if (categoriesCountResult.ResultStatus==ResultStatus.Success && articlesCountResult.ResultStatus == ResultStatus.Success 
                && commentCountResult.ResultStatus == ResultStatus.Success && userCount>-1 &&
