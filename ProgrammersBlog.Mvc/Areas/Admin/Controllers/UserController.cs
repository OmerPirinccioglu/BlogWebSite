...
namespace ProgrammersBlog.Mvc.Areas.Admin.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Add(UserAddDto userAddDto)
        {
            if (ModelState.IsValid)
            {
                var uploadImageDtoResult = await _imageHelper.UploadUserImage(userAddDto.UserName,userAddDto.PictureFile);
                userAddDto.Picture = uploadImageDtoResult.ResultStatus == ResultStatus.Success ? uploadImageDtoResult.Data.FullName : "userImages/defaultUser.png";
        ...
        public async Task<IActionResult> Update(UserUpdateDto userUpdateDto)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    var uploadImageDtoResult = await _imageHelper.UploadUserImage(userUpdateDto.UserName, userUpdateDto.PictureFile);
                    userUpdateDto.Picture = uploadImageDtoResult.ResultStatus == ResultStatus.Success ? uploadImageDtoResult.Data.FullName : "userImages/defaultUser.png";
